...
2. Set `ALLOWED_ORIGINS` in Worker configuration and replace the permissive CORS wildcard with the exact production and approved preview origins. Include the current Vercel domain during the transition.
