const CACHE_NAME = 'komunalka-v6.4.0';
const PRECACHE_URLS = [
  './', './index.html', './dist/tailwind.css?v=6.4.0', './styles/fonts.css?v=6.4.0', './styles/app-shell.css?v=6.4.0', './styles/quiet-ui.css?v=6.4.0', './sync-queue.js?v=6.4.0', './app.js?v=6.4.0', './ui-dialogs.js?v=6.4.0', './export-tools.js?v=6.4.0', './record-card.js?v=6.4.0', './year-report-image.js?v=6.4.0', './ai-chat.js?v=6.4.0',
