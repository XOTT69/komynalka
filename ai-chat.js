...
Відповідай ТІЛЬКИ українською мовою. Будь лаконічним — 1-3 речення максимум.
...
- Не вигадуй дані яких немає.`;
    ...
    _render() {
        ...
        // БАГ 1 ВИПРАВЛЕНО: _bindSuggestions() видалено,
        // делегований listener в init() покриває все
    ...
    _msgHTML(role, content, ts) {
        ...
        if (isUser) {
            return `<div class="flex justify-end mb-3 ai-msg-in">
                <div class="max-w-[82%]">
                    <div class="bg-brand text-white px-4 py-2.5 rounded-2xl rounded-br-md text-sm leading-relaxed shadow-md shadow-brand/20"><p>${formatted}</p></div>
    ...
    init() {
        ...
        // БАГ 1 ВИПРАВЛЕНО: один делегований listener замість
        // прямих listeners у _bindSuggestions()
